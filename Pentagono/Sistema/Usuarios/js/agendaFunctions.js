...
function bloquearFinalAno(){
    $(function () {
       $('.btn_mudar_mes_prox').click(false);
       $('.btn_mudar_mes_prox').css('opacity','0.3');
    });
}
...
function abreModal9(dia){
    $('#modalBody9').fadeIn();  
    document.getElementById('modalBody9').style.display = 'flex'; 
  }
...
function teste(btn){
  var botao = document.getElementById("botao"+btn).value;
