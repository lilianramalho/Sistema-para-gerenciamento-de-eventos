<?php
	...
	$conn = abrirConexao();
	$sql = "SELECT nomeusuario , cepusuario , datanascimentousuario , cpfusuario , logradourousuario , bairrousuario , complementousuario , numeroresidenciausuario , celularusuario , residencialusuario , emailusuario , sexousuario  FROM tbusuario";
	...
	$query = "SELECT count(nomeusuario) FROM tbusuario";
