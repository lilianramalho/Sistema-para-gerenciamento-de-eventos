<?php
	...
	$sql = "SELECT nomeevento , descricaoevento , datainicioevento , datafimevento FROM tbevento WHERE datainicioevento = '$data' ";
	...
	$query = "SELECT count(codevento) , datainicioevento , datafimevento from tbevento WHERE datainicioevento = '$data'";
