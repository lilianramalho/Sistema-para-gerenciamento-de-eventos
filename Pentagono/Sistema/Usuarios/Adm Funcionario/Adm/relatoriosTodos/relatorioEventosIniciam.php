	...
	$sql = "SELECT nomeevento , descricaoevento , datainicioevento , datafimevento FROM tbevento WHERE  eventoexiste = '1' and datainicioevento = '$data' ";
	...
	$query = "SELECT count(codevento) , datainicioevento , datafimevento from tbevento WHERE eventoexiste = '1' and datainicioevento = '$data'";
	...
	$dompdf->load_html("
			...
			<text id='tituloRelatorio'>
				Eventos que iniciam em ".$dataInicioPOST." 
			</text>
