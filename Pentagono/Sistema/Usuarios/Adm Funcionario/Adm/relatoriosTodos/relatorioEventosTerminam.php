<?php
	...
	$sql = "SELECT nomeevento , descricaoevento , datainicioevento , datafimevento FROM tbevento WHERE eventoexiste = '1' and datafimevento = '$data'";
	...
	$query = "SELECT count(codevento) , datainicioevento , datafimevento from tbevento WHERE eventoexiste = '1' and datafimevento = '$data'";
