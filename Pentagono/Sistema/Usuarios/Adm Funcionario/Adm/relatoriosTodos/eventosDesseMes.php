...
include_once 'conexao.php';
	...
	$sql = "SELECT nomeevento , descricaoevento , datainicioevento , datafimevento FROM tbevento
				WHERE MONTH(datainicioevento) like MONTH(curdate()) or MONTH(datafimevento) like MONTH(curdate())
					and eventoexiste = '1'";
	...
	$query = "SELECT count(codevento) , datainicioevento , datafimevento from tbevento
					WHERE MONTH(datainicioevento) like MONTH(curdate()) or MONTH(datafimevento) like MONTH(curdate()) and eventoexiste = '1'";
