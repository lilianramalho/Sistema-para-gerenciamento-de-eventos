<?php
	...
	$sql = "SELECT nomeevento , descricaoevento , datainicioevento , datafimevento FROM tbevento WHERE eventoexiste = '1' and datainicioevento between '$datainicio' and '$datafim'";
	...
	$query = "SELECT count(codevento) , datainicioevento , datafimevento from tbevento WHERE eventoexiste = '1' and datainicioevento between '$datainicio' and '$datafim'";
	$result = mysqli_query($conn , $query);
	$linha_result = mysqli_fetch_assoc($result);
	$resultadosEncontrados = $quantidade;
	...
	$partesDataInicioPost = explode('-', $datainicio);
	...
	$dompdf->load_html("
			...
			<text id='tituloRelatorio'>
				Eventos cadastrados entre ".$dataInicioPOST." e ".$dataFimPOST."
			</text>
