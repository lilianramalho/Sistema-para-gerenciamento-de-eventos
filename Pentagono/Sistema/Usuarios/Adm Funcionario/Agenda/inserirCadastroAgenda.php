...
// echo mysqli_num_rows($result);
	...
	if ($jaTem == true) {
			echo "Horário ja agendado, tente novamente!";
			...
			echo "Não é possível agendar com um horário inicial maior que o de término!";

	} else if ($horaSeparadaComeca == $horaSeparadaTermina && $minutosSeparadoComeca == $minutosseparadoTermina) {
			echo "Insira um horário de saída maior!";
			...
			echo "O horário de abertura é as 08:00!";
	}
			...
			echo "O horário de fechamento é as 18:00!";
